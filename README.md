...
Smart contracts act as the decentralized backend logic for minting, ownership, sale listings, and purchases. All transactions are signed and sent through the connected wallet.
